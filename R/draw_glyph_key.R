draw_glyph_key <- function(key,
  ...
  g_axis_x <- grid::segmentsGrob(
    x0 = grid::unit(-5, "native"),
    y0 = grid::unit(0, "native"),
    x1 = grid::unit(10, "native"),
    y1 = grid::unit(0, "native"),
    gp = grid::gpar(col = axis_col, alpha = axis_alpha)
  )
  g_axis_y <- grid::segmentsGrob(
    x0 = grid::unit(0, "native"),
    y0 = grid::unit(10.5, "native"),
    x1 = grid::unit(0, "native"),
    y1 = grid::unit(-10.5, "native"),
    gp = grid::gpar(col = axis_col, alpha = axis_alpha)
  )
